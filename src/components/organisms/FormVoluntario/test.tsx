...
//   }
describe('TESTE', () => it('Teste', () => expect(true).toBeTruthy()))
//   const Elements = () => {
//     return {
...
//       const anoFormacao = screen.getByTestId('anoFormacao')
//       fireEvent.change(anoFormacao, { target: { value: '2021' } })
//       const crp = screen.getByLabelText('CRP')
//       fireEvent.change(crp, { target: { value: 'TESTE 123' } })
//       const especializacoes = screen.getByLabelText(
//         'Possui especialização? Se sim, qual(is)?'
//       )
//       fireEvent.change(especializacoes, {
//         target: { value: 'Realizar testes' }
//       })
...
//       expect(superiorCompleto).toBeChecked()
//       expect(tipoAtendente).toBeChecked()
//       expect(crp).toHaveValue('TESTE 123')
